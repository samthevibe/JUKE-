...
// Storage for uploads (covers + mp3s)
...
let albums = [
  {
    ...
    artist: "Artist 1",
    label: "JUKE Records",
    bio: "This is Album 1, a JUKE classic.",
    coverUrl: "",
    streams: 0,
    tracks: [
      { id: 1, title: "Track 1", duration: "3:45", streams: 0, file: "song1.mp3" },
      { id: 2, title: "Track 2", duration: "2:50", streams: 0, file: "song2.mp3" }
    ]
  }
];
